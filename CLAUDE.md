...
- `docs/versionamento_kist_v3.59-v3.89.md` — o que mudou em cada versão e por quê. Versões até a v3.58 estão no núcleo do Analista (`config_kist['capacidades_nucleo']`).
