// Versão do bundle atual e checagem de atualização — mesmo esquema do
// kist-frontend (v3.95, ver frontend/src/versao.js).
import { useEffect, useState } from "react";

export const APP_VERSION = typeof __APP_VERSION__ !== "undefined" ? __APP_VERSION__ : "dev";

// Derruba os cookies deste domínio e força um reload ignorando cache. Não mexe
// em localStorage (é lá que o login mora: kist_crm_token/kist_crm_user), então
// o operador não perde a sessão, só o bundle antigo.
...
// Confere a versão publicada ao carregar, a cada 5 min e sempre que a aba
// volta a ficar visível. Achou diferença → atualiza sozinho.
